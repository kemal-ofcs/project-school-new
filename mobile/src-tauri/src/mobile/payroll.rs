    ...
    let slip = conn
        .query_row(
            ...
            SELECT
                ...
                COALESCE(pi.total_teaching_jp, 0),
                COALESCE(pi.teaching_salary, 0),
                pi.rate_per_hour,
                pi.basic_salary,
                pi.overtime_salary,
                pi.gross_salary,
            ...
            |row| {
                Ok(json!({
                    ...
                    "total_teaching_jp": row.get::<_, i64>(14)?,
                    "teaching_salary": row.get::<_, i64>(15)?,
                    "rate_per_hour": row.get::<_, i64>(16)?,
                    "basic_salary": row.get::<_, i64>(17)?,
                    "overtime_salary": row.get::<_, i64>(18)?,
                    "gross_salary": row.get::<_, i64>(19)?,
                    "total_allowances": row.get::<_, i64>(20)?,
                    "total_deductions": row.get::<_, i64>(21)?,
                    "bpjs_employee_total": row.get::<_, i64>(22)?,
                    "bpjs_company_total": row.get::<_, i64>(23)?,
                    "pph21_amount": row.get::<_, i64>(24)?,
                    "net_salary": row.get::<_, i64>(25)?,
                    "breakdown_snapshot": row.get::<_, String>(26)?,
                    "created_at": row.get::<_, String>(27)?,
                }))
            },
        )
