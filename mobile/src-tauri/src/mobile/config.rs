...
/// menjadi kunci identitas lokal (`mobile_client_identity`, vault offline) dan
...
/// yang sudah dipensiunkan. Cerminan `config.rs` Desktop.
...
impl MobileState {
    pub fn initialize(app: &AppHandle) -> Result<Self, String> {
        ...
        let http = Client::builder()
            ...
            .user_agent("Manajemen-Sekolah-Mobile/0.1")
            .build()
