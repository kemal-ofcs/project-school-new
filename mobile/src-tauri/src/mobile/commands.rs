...
#[tauri::command]
pub fn desktop_get_lesson_periods(state: State<'_, MobileState>) -> Result<Value, CommandError> {
    require_permission(&state, "home.view")?;
...
#[tauri::command]
pub fn desktop_get_jp_settings(state: State<'_, MobileState>) -> Result<Value, CommandError> {
    require_permission(&state, "home.view")?;
...
#[tauri::command]
pub fn desktop_backfill_id_cards(state: State<'_, MobileState>) -> Result<Value, CommandError> {
    require_permission(&state, "employees.manage")?;
