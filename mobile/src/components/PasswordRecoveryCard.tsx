        ...
        <div className="mt-5 space-y-3">
          <ul className="grid grid-cols-2 gap-2 sm:grid-cols-4">
            {codes.map((code) => (
              <li
                key={code}
                className="select-all rounded-xl border border-amber-400/25 bg-amber-400/10 px-2 py-2.5 text-center font-mono text-xs font-black tracking-wider text-amber-100"
              >
                {code}
              </li>
            ))}
