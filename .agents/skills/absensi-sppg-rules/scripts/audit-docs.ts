...
const DOCS = [
	"CLAUDE.md",
	".agents/penting.md",
	"web-desktop/AGENTS.md",
	"mobile/AGENTS.md",
	".agents/skills/absensi-sppg-rules/SKILL.md",
	".agents/skills/absensi-sppg-rules/references/01-bootstrap-and-security.md",
	".agents/skills/absensi-sppg-rules/references/02-sync-canonical-and-outbox.md",
